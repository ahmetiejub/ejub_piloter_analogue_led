...
void app_main(void)
{
    ...
    // ======= MODIFICATION : Configuration GPIO 23 pour la LED =======
    ...
    gpio_config(&io_conf);
    gpio_set_level(GPIO_NUM_23, 0);  // LED éteinte au démarrage
    ESP_LOGI(TAG, "GPIO23 configured for LED control");
    // ================================================================
    ...
    printf("BACnet Server Demo\n" "BACnet Stack Version %s\n"
        "BACnet Device ID: %lu\n" "Max APDU: %d\n", BACnet_Version,
        (unsigned long)Device_Object_Instance_Number(), MAX_APDU);
